...
public class BloquesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bloques.add( new Bloque(1, "Bioclimatico", "52", "https://stratto.weebly.com/uploads/1/3/6/6/13668912/55122_orig.jpg", 12) );
        bloques.add( new Bloque(1, "Informatica", "23", "http://www.prensalibrecasanare.com/uploads/posts/2013-07/1375172099_aulas-inconclusas-jorge-eliecer-gaitan11.jpg", 2) );
        bloques.add( new Bloque(1, "Matematicas", "12", "https://www.elcomercio.com/files/article_main/uploads/2018/05/21/5b0305928c14a.jpeg", 31) );

        bloquesAdapter = new BloquesAdapter(bloques, getContext());
